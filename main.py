...
g = Particles.ParticleGenerator(pos=pygame.mouse.get_pos(), color_=(255, 255, 255), decay_rate=0.1, direction=0, mspeed=1, gravity=0.1, spread=90, surfaceeffects=[[SurfaceEffects.glow, "radius", (20, 20, 80)]])
